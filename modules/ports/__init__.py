...
class ClassifierProviderError(RuntimeError):
    """A body-free typed failure returned by the classifier provider boundary."""


class ClassifierAuthenticationError(ClassifierProviderError):
    """The dedicated classifier identity requires protected recovery."""

    def __init__(self) -> None:
        super().__init__("classifier authentication unavailable")


class ClassifierQuotaError(ClassifierProviderError):
...
class ClassifierTransientError(ClassifierProviderError):
