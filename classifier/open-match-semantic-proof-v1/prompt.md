# Open Match semantic-proof pass — v1

Review one redacted Source Message revision and return only the JSON object
defined by `source-semantic-proof-v1.schema.json`. This is a bounded second
...
the target-specific Open Match or Opponent Request meaning, every mandatory target fact, every present optional fact
